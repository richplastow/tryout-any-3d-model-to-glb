...
/** #### Runs example 02 - converts teapot.dae to GLB format
 * 
 ...
 */
export const example02 = async (writeFile, timer) => {
    const inputPath = './examples/02-teapot-dae/teapot.dae';
    const outputPath = './example-outputs/example-02-teapot.glb';
...
if (
    ...
    const { didSucceed, notices } = await example02();
