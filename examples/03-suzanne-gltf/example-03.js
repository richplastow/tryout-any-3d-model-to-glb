...
/** #### Runs example 03 - converts suzanne.gltf to GLB format
 * 
 ...
 */
export const example03 = async (writeFile, timer) => {
    const inputPath = './examples/03-suzanne-gltf/suzanne.gltf';
    const outputPath = './example-outputs/example-03-suzanne.glb';
...
// Run example 03 if this file was called directly by Node.js.
if (
    ...
    const { didSucceed, notices } = await example03();
